...
#businesses$State <- reverse_geocode(businesses$Longitude, businesses$Latitude, output = "more", source = "osm")
...
ggplot() +
  ...
  geom_point(data = valid_locations, aes(x = Longitude, y = Latitude), color = "blue", size = 1) +    
